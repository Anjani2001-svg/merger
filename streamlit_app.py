...
# ── Watermark / badge cover coordinates (at 1920×1080) ───────────────────
...
#   These cover the "NotebookLM" logo + course title text that appears on
#   the intro card at the very start of every NotebookLM-generated video.
#
#   "1-line title" → short course titles that fit on one line
#   "2-line title" → longer titles that wrap to two lines (taller box)
# ─────────────────────────────────────────────────────────────────────────
WM_TITLE_1L_X, WM_TITLE_1L_Y = 340, 65
WM_TITLE_1L_W, WM_TITLE_1L_H = 1240, 260

WM_TITLE_2L_X, WM_TITLE_2L_Y = 340, 65
WM_TITLE_2L_W, WM_TITLE_2L_H = 1240, 380

TITLE_COVER_RADIUS = 12
